  ...
  tags: {
    ...
    autoform: {
      ...
      options: function() {
        ...
        var currentRouteController = Router.current();
        var item = currentRouteController.layoutTemplate === 'adminLayout' ? currentRouteController.data().item : currentRouteController.data();
        console.log(item);
